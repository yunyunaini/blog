<template>
  <div class="author">
    <router-link target="_blank" :to="{path: '/author', query:{author: userInfo.author}}" class="author-avatar" >
    ...
    <div class="author-info">
      <router-link target="_blank" v-html="userInfo.author" :to="{path: '/author', query:{author: userInfo.author}}" :class="type ? `author-name--${type}` : 'author-name'">
